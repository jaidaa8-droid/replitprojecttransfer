...
const SEED_EVENTS = [
  ...
  { title: "Cyber Attack on Critical Infrastructure", description: "A coordinated ransomware attack has targeted power grids in Eastern Europe.", category: "Cyber", severity: 5, confidence: 0.85, latitude: 50.4501, longitude: 30.5234, timestamp: h(29), sources: ["Reuters", "CyberSec Intel"] },
  { title: "Supply Chain Disruption in South China Sea", description: "Naval exercises have caused significant delays in shipping lanes.", category: "Supply chain", severity: 4, confidence: 0.9, latitude: 14.0583, longitude: 114.9667, timestamp: h(49), sources: ["Maritime Trade Org"] },
...
async function seedDatabase() {
  ...
  const existingTitles = new Set(existingTitlesList);
