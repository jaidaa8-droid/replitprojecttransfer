...
const SEED_EVENTS = [
  ...
  // 24-hour window
  { title: "Saudi Arabia Convenes Emergency GCC Summit Over Iran War", description: "Saudi Arabia chairs an emergency Gulf Cooperation Council summit in Riyadh as US-Israeli strikes on Iran continue. King Salman bin Abdulaziz calls for an immediate halt to hostilities and warns that the conflict threatens catastrophic spillover to the broader Arabian Gulf region. The six GCC member states issue a joint communiqué demanding de-escalation.", category: "Diplomatic", severity: 4, confidence: 0.97, latitude: 24.69, longitude: 46.72, timestamp: h(3), sources: ["Al Jazeera", "Reuters", "Arab News"] },
  { title: "Saudi Aramco Raises Security Readiness at Gulf Facilities Amid Iran War", description: "Saudi Aramco activates its highest internal security protocols at offshore and coastal oil and gas facilities in the Arabian Gulf, including the Ras Tanura terminal — the world's largest crude oil export facility. The company confirms operational continuity but acknowledges elevated threat conditions as the Iran-US-Israel conflict risks spreading to Gulf infrastructure.", category: "Energy", severity: 4, confidence: 0.97, latitude: 26.64, longitude: 50.16, timestamp: h(12), sources: ["Reuters", "Bloomberg", "Arab News"] },
  ...
  // 48-hour window
  { title: "Saudi Arabia Distances Itself From US-Israel Campaign, Calls for Ceasefire", description: "Saudi Arabia's foreign ministry issues a formal statement declining to endorse the US-Israeli military campaign against Iran, calling it a violation of Iranian sovereignty. Riyadh urges Washington and Tel Aviv to pursue a diplomatic path and warns that continued strikes threaten stability across the entire Gulf Cooperation Council region.", category: "Diplomatic", severity: 4, confidence: 0.97, latitude: 24.69, longitude: 46.72, timestamp: h(28), sources: ["Al Jazeera", "Reuters", "Saudi Press Agency"] },
  ...
  // 5-day window
  { title: "OPEC+ Calls Emergency Session as Iran War Disrupts Gulf Oil Markets", description: "OPEC+ convenes an emergency virtual session chaired by Saudi Energy Minister Prince Abdulaziz bin Salman to coordinate a response to the oil market disruption caused by the US-Israel campaign against Iran. Participants debate releasing strategic petroleum reserves versus increasing production. Brent crude has surged more than 30% since the strikes began.", category: "Energy", severity: 4, confidence: 0.97, latitude: 24.69, longitude: 46.72, timestamp: h(65), sources: ["Reuters", "Bloomberg", "OPEC Secretariat"] },
  { title: "Saudi Arabia and UAE Deploy Naval Patrols to Secure Arabian Gulf Shipping Lanes", description: "Saudi and Emirati naval forces launch coordinated patrols in the Arabian Gulf and the Gulf of Oman to safeguard commercial shipping lanes as the Iran-US-Israel conflict raises fears of Iranian retaliation against Gulf energy infrastructure. The combined fleet includes frigates, fast-attack craft and maritime patrol aircraft.", category: "Military activity", severity: 4, confidence: 0.97, latitude: 25.28, longitude: 55.30, timestamp: h(90), sources: ["Al Jazeera", "Reuters", "The National"] },
  ...
  // 7-day window
  { title: "Saudi Arabia Summons US Ambassador Over Iran Strikes, Warns of Gulf Spillover", description: "Saudi Arabia summons the US Ambassador to Riyadh to formally protest the US-Israeli military campaign against Iran. The Saudi foreign ministry warns that unilateral strikes on a neighbouring state set a dangerous precedent, threaten Saudi Arabia's own security, and risk triggering retaliatory Iranian action against Gulf oil infrastructure.", category: "Diplomatic", severity: 4, confidence: 0.97, latitude: 24.69, longitude: 46.72, timestamp: h(130), sources: ["Al Jazeera", "Reuters", "Saudi Press Agency"] },
  { title: "GCC Leaders Issue Emergency Declaration as Iran Conflict Spreads to Gulf", description: "The Gulf Cooperation Council issues an emergency joint declaration signed by Saudi Arabia, UAE, Kuwait, Qatar, Bahrain and Oman expressing grave concern over the escalating US-Israel military campaign against Iran. The declaration calls for an immediate ceasefire, protection of civilian infrastructure and resumption of dialogue under UN auspices.", category: "Diplomatic", severity: 4, confidence: 0.97, latitude: 25.28, longitude: 51.55, timestamp: h(155), sources: ["Al Jazeera", "Reuters", "Gulf News"] },
