...
const SEED_EVENTS = [
  { title: "Cyber Attack on Ukrainian Power Grid", description: "Coordinated ransomware campaign targets electricity distribution networks in Kyiv and Kharkiv, causing partial blackouts.", category: "Cyber", severity: 5, confidence: 0.88, latitude: 50.45, longitude: 30.52, timestamp: h(2), sources: ["Reuters", "CERT-UA", "CISA"] },
  ...
  { title: "Saudi Arabia Freezes PIF Overseas Investments Amid War Risk", description: "Public Investment Fund halts new international deployments and recalls liquidity from global equity positions as Eastern Province conflict risk escalates. Sovereign wealth fund shifts to domestic war-economy posture.", category: "Economic disruptions", severity: 3, confidence: 0.88, latitude: 24.68, longitude: 46.72, timestamp: h(160), sources: ["Reuters", "Financial Times", "Bloomberg"] },
  ...
  { title: "Cyber Attack on Critical Infrastructure", description: "A coordinated ransomware attack has targeted power grids in Eastern Europe.", category: "Cyber", severity: 5, confidence: 0.85, latitude: 50.4501, longitude: 30.5234, timestamp: h(29), sources: ["Reuters", "CISA", "CERT-UA"] },
  { title: "Supply Chain Disruption in South China Sea", description: "Naval exercises have caused significant delays in shipping lanes.", category: "Supply chain", severity: 4, confidence: 0.9, latitude: 14.0583, longitude: 114.9667, timestamp: h(49), sources: ["Reuters", "IMO", "Splash247"] },
  { title: "Energy Price Spike", description: "OPEC+ announces surprise production cuts.", category: "Energy", severity: 3, confidence: 0.95, latitude: 23.8859, longitude: 45.0792, timestamp: h(69), sources: ["Bloomberg"] },
  { title: "Japan ADIZ Drone Intercept Near Senkaku", description: "JMSDF P-1 patrol aircraft intercepts Chinese military drone flying 15km inside Japan ADIZ near Senkaku Islands.", category: "Military activity", severity: 3, confidence: 0.88, latitude: 25.75, longitude: 123.47, timestamp: h(53), sources: ["NHK", "Kyodo News", "Janes Defence Weekly"] },
  { title: "Gulf of Guinea Piracy Wave", description: "MDAT-GoG reports 14 crew kidnappings from three separate vessels in international waters off Nigeria within a single week.", category: "Trade chokepoints", severity: 4, confidence: 0.87, latitude: 3.5, longitude: 3.3, timestamp: h(62), sources: ["IMB Piracy Reporting Centre", "Splash247", "Lloyds List"] },
  { title: "Suez Canal Emergency Toll Surcharge", description: "Egyptian Suez Canal Authority imposes 15 percent emergency toll surcharge citing Red Sea security costs; 23 carriers divert via Cape of Good Hope.", category: "Trade chokepoints", severity: 3, confidence: 0.96, latitude: 30.42, longitude: 32.34, timestamp: h(99), sources: ["Suez Canal Authority", "Drewry", "Lloyds List"] },
  { title: "Australia-China Iron Ore Tariff Row", description: "Beijing imposes 25 percent tariff on Australian iron ore citing quality irregularities, hitting 60 percent of Pilbara export revenue.", category: "Sanctions", severity: 3, confidence: 0.86, latitude: -22.9, longitude: 118.1, timestamp: h(93), sources: ["Australian Financial Review", "Bloomberg", "Nikkei Asia"] },
  { title: "Bangladesh Garment Worker General Strike", description: "500,000 RMG workers halt production at 600 factories after government rejects 140 percent minimum wage demand, disrupting global supply chains.", category: "Economic disruptions", severity: 3, confidence: 0.91, latitude: 23.81, longitude: 90.41, timestamp: h(80), sources: ["Reuters", "Clean Clothes Campaign", "Financial Times"] },
  { title: "China Deploys Coast Guard Fleet Near Taiwan", description: "PLAN Coast Guard stations 34 vessels in formation along Taiwan's 24nm contiguous zone, the largest peacetime maritime pressure operation on record. Taiwan scrambles F-16 patrols.", category: "Military activity", severity: 5, confidence: 0.95, latitude: 23.8, longitude: 121.0, timestamp: h(33), sources: ["Kyodo News", "Reuters", "CSIS AMTI"] },
  { title: "Iran Launches Ballistic Missiles at US Al-Udeid Base", description: "IRGC fires 14 Shahab-3 ballistic missiles at Al-Udeid Air Base in Qatar. THAAD intercepts 11; 3 impact runway and fuel depot, killing 4 US airmen. US President authorises retaliatory strikes on IRGC infrastructure.", category: "Military activity", severity: 5, confidence: 0.97, latitude: 25.12, longitude: 51.32, timestamp: h(27), sources: ["CENTCOM", "Reuters", "BBC", "Al Jazeera"] },
  { title: "US Strikes IRGC Missile Bases Inside Iran", description: "US Air Force and Navy conduct coordinated strikes on six IRGC ballistic missile launch sites across Khuzestan and Fars provinces in retaliation for Al-Udeid attack. B-2 stealth bombers deployed from Diego Garcia. Iran vows to close all Gulf waterways permanently.", category: "Military activity", severity: 5, confidence: 0.98, latitude: 32.43, longitude: 53.69, timestamp: h(24), sources: ["CENTCOM Statement", "Reuters", "BBC", "The War Zone"] },
  { title: "Hezbollah Fires 3,000 Rockets at Northern Israel", description: "Hezbollah opens full northern front with 3,000+ rocket barrage targeting Haifa, Tiberias and Kiryat Shmona as Iran conflict escalates. Iron Dome at capacity; 14 killed in Haifa port strike. Israel declares state of war.", category: "Conflicts", severity: 5, confidence: 0.96, latitude: 32.81, longitude: 34.99, timestamp: h(24), sources: ["IDF Spokesperson", "Reuters", "Haaretz", "Al Jazeera"] },
  { title: "Turkey Closes Bosphorus to Warships", description: "Ankara invokes Montreux Convention Article 19 to deny passage of all warships through the Bosphorus Strait, citing active conflict in Black Sea. US and Russian naval assets trapped in respective seas.", category: "Trade chokepoints", severity: 4, confidence: 0.94, latitude: 41.08, longitude: 29.05, timestamp: h(25), sources: ["Turkish Foreign Ministry", "Reuters", "Jane's Defence", "Lloyd's List"] },
  { title: "Israel Launches Ground Invasion of Southern Lebanon", description: "IDF ground forces cross into southern Lebanon under air cover in largest operation since 2006 war. 3 armoured brigades advance on Tyre and Sidon. UN calls emergency Security Council session. Lebanon government declares national emergency.", category: "Military activity", severity: 5, confidence: 0.97, latitude: 33.27, longitude: 35.2, timestamp: h(6), sources: ["IDF Spokesperson", "Reuters", "Haaretz", "BBC", "UN UNIFIL"] },
  { title: "Iran Mines Persian Gulf Shipping Lanes", description: "IRGC Navy deploys underwater mines across key commercial shipping channels in the Persian Gulf following US airstrikes. Lloyd's of London suspends all Gulf marine insurance. 140 tankers trapped at anchor off Fujairah.", category: "Trade chokepoints", severity: 5, confidence: 0.95, latitude: 25.92, longitude: 55.51, timestamp: h(7), sources: ["US Navy 5th Fleet", "Lloyd's List", "Reuters", "Splash247"] },
];
...
async function seedDatabase() {
  const [existingTitlesList, existingCountries, existingSectors] = await Promise.all([
    storage.getAllEventTitles(),
    storage.getCountries(),
    storage.getSectorRisks(),
  ]);

  // Purge any events referencing Vision 2030 (policy cleanup — affects dev and production)
  await storage.deleteEventsByTitlePattern("%Vision 2030%");

  // Insert any seed events not already present (match by title, checks ALL events regardless of confidence)
  const existingTitles = new Set(existingTitlesList.filter(t => !t.includes("Vision 2030")));
